  ...
  return (
    <div id='skills' className='bg-cover bg-center bg-no-repeat' style={{backgroundImage: `url(${skbg})`}}>
        ...
        className=' flex flex-col justify-center items-center text-center w-full max-w-screen-lg mx-auto pt-10 lg:pb-5 text-blue-700'>
          <h1 className='font-black text-white text-4xl md:text-5xl xl:text-6xl font-[Inter]'>What Defines Me</h1>
        ...
        <div className='grid grid-cols-1 gap-1 py-2 mx-auto lg:grid-cols-2 sm:px-10 '>
            ...
            className='text-white flex justify-center font-extrabold text-3xl pb-6 md:pb-0 font-[Inter]'>Programming Skills</motion.h2>
            <div className='flex flex-col justify-between items-between w-[80%] lg:w-full max-w-screen-xl md:py-10 md:justify-center md:items-center'>
              ...
              viewport={{ once: true }}
                ...
                className='text-white grid grid-cols-2 gap-10 justify-center items-center font-[Inter]'>
              ...
              viewport={{ once: true }}
                ...
                className='text-white grid grid-cols-2 gap-10 mt-6 justify-center items-center font-[Inter]'>
                <div className='flex justify-start items-center gap-x-16'>
            ...
            <div className='px-9 flex flex-col items-center justify-center font-[Inter]'>
            <motion.h2 initial={{ opacity: 0, y: 80 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 1.5, ease: 'easeInOut', }}
              viewport={{ once: true }}
            ...
            <div className='flex justify-center items-center w-full max-w-screen-xl mx-auto py-4'>
              ...
              viewport={{ once: true }}
                ...
                className='text-white flex justify-center font-extrabold text-3xl pb-6 font-[Inter]'>Other Skills</motion.h2>
            </div>
            <div className='grid grid-cols-1 gap-10 pb-5 mx-auto w-full max-w-screen-xl px-20 xl:px-0 xl:grid-cols-2'>
              ...
              viewport={{ once: true }}
                ...
                className='bg-blue-950 bg-opacity-35 w-full mx-auto rounded-xl items-center flex flex-col justify-start lg:p-4 text-center hover:scale-105 transition-all duration-200 cursor-pointer'>
                    ...
                    <h1 className='text-white font-bold text-lg lg:text-2xl py-2 font-[Inter]'>Software Troubleshooting</h1>
                    <p className='text-sm lg:text-lg font-semibold text-white md:p-2 font-[Inter]'>I have solid troubleshooting skills, with experience in diagnosing and resolving software issues, particularly on Windows operating systems.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 1, ease: 'easeInOut', }}  
              viewport={{ once: true }}
                ...
                className='bg-blue-950 bg-opacity-25 w-full mx-auto rounded-xl items-center flex flex-col justify-start p-4 text-center hover:scale-105 transition-all duration-200 cursor-pointer'>
                    ...
                    <h1 className='text-white font-bold text-lg lg:text py-2 font-[Inter]'>Computer Skills</h1>
                    <p className='text-sm lg:text-lg font-semibold text-white md:p-2 font-[Inter]'>I have strong computer skills, including using Windows, Microsoft Office, Google Workspace, and managing files. I'm also skilled in internet research and using technology to find effective solutions. </p>
                </motion.div>
            </div>
        </div>
  )
