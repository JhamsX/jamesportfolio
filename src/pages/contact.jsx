  ...
  return (
    <div id='contact' className='py-2 text-blue-700 bg-cover bg-center bg-no-repeat w-auto"' style={{backgroundImage: `url(${cntbg})`}}>
        ...
        className=' flex flex-col justify-center items-center text-center w-full max-w-screen-lg mx-auto py-10 '>
          <h1 className='font-black text-white text-4xl md:text-5xl xl:text-6xl font-[Inter]'>Contact</h1>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 justify-center items-center '>
            ...
            className='px-10 lg:px-28 backdrop-blur-sm w-full max-w-screen-md mx-auto text-white flex flex-col justify-center items-center gap-y-5'>
                 <input type="text" required placeholder='Your Name' className='font-[Inter] w-full bg-[#0f0737] p-3 border border-gray-400 border-opacity-35 rounded-xl' />
                 <input type="text" required placeholder='Your Email' className='font-[Inter] w-full bg-[#0f0737] p-3 border border-gray-400 border-opacity-35 rounded-xl' />
                 <textarea type="text" rows={4} placeholder='Your Message' className='font-[Inter] w-full bg-[#0f0737] p-3 h-auto border border-gray-400 border-opacity-35 rounded-xl' />
                 <button>
                <input type="submit" name="" id="" className='font-[Inter] bg-[#0f0737] rounded-full p-3 w-32 text-center text-white border border-gray-400 border-opacity-35 font-semibold text-base cursor-pointer hover:bg-blue-800 hover:text-white delay-300 transition-colors duration-300'/>
            </button>
